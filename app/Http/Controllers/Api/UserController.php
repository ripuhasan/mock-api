<?php
    ...
    class UserController extends Controller
    {
        ...
        public function index(Request $request)
        {
            ...
            if (file_exists('json_data/admin/v1/users/users_163.json')) {
                $data = file_get_contents('json_data/admin/v1/users/users_163.json');
     ...
     *      path="/api/admin/v1/users",
     *      tags={"User"},
     *      summary="Store Users in DB",
     *      description="Store Users in DB",
     *      @OA\RequestBody(
     *         required=true,
     *         @OA\JsonContent(
     *            required={"firstName","lastName"},
     *            @OA\Property(property="firstName", type="string", format="string"), @OA\Property(property="lastName", type="string", format="string")
     *         ),
     *      ),
     *     @OA\Response(
     ...
     */
        ...
        public function store(Request $request)
        {
            try{
                ...
                $json_string = file_get_contents('json_data/admin/v1/users/users_163.json');
                ...
                file_put_contents('json_data/admin/v1/users/users_163.json', $json_string);
        ...
        public function update(Request $request, $id)
        {
            try{
                ...
                $data[$index]["first_name"] = $request->firstName; $data[$index]["last_name"] = $request->lastName;

                // Convert the updated data back to JSON
                $json_data = json_encode($data, JSON_PRETTY_PRINT);

                // Write the updated JSON data back to the file
                file_put_contents('json_data/admin/v1/users/users_163.json', $json_data);
                return response()->json([
                    "success" => true,

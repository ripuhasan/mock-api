                  ...
                  <div class="col-lg-12">
                        <div class="card">
                            <div class="text-right mt-2 mr-2">
                                <a href="{{ route('admin.custom.mock.api.edit', $row->id) }}" class="btn btn-sm btn-primary"><i class="ti-pencil-alt"></i></a>
                                                ...
                                                <div class="example mb-10">
                                                    <h5 class="mt-2 ml-2">Body</h5>
                                                      <div class="example-code">
                                                       ...
                                                       <code>
                                                        <?php
                                                        if (!file_exists('json_data/'.$row->url.'/'.$model.'_'.$row->id.'.json')) {
                                                            echo "No json data found!";
                                                        }else{
                                                            $json = file_get_contents('json_data/'.$row->url.'/'.$model.'_'.$row->id.'.json'); 

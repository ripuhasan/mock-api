                        ...
                        <div class="card-body">
                            <div class="basic-form">
                              ...
                              <div class="col-md-6">
                                    <div class="form-group">
                                          <label>Model *</label>
                                          <input type="text" class="form-control" name="model" value="{{ $row->model }}" required readonly>
                                    </div>
                              </div>
                              </div>
                              <div class="row">
                                    <div class="col-md-6">
                                          <div class="form-group">
                                                ...
                                                <select name="input_field[]" class="form-control selectpicker" id="tag-input10" multiple data-live-search="true" required>
                                                    ...
                                                    <option @foreach($selected_fields as $key => $fi) {{ $fi == $field->key ? 'selected' : '' }} @endforeach value="{{ $field->key }}">{{ $field->name }}</option>
                                                    @endforeach
                                              </select>
                                          </div>
                                    </div>
